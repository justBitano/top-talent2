...
namespace TopTalentWebClient1.Areas.Admin.Controllers
{
    ...
    public class AdminUsersController : Controller
    {
        ...
        public AdminUsersController(TopTalent2Context context, INotyfService notifyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Password,FullName,Phone,Description,Image,Status")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,Password,FullName,Phone,Description,Image,Status")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
